<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ExceptionsTiendasUpload.aspx.vb" Inherits="ICMTools.ExceptionsTiendasUpload" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="container-fluid">
        <div class="d-flex gap-1">
            ...
            <a href="../Pages/ExceptionsTiendasUpload.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
                <i class="fas fa-upload fa-2x"></i>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Form para Importación de Excepciones de Tiendas con procesos de validación" />
    <meta name="author" content="Equipo SOINF" />
    <title>Excepciones de Tiendas</title>
    <script type="text/javascript">
        ...
        const pageConfig = {
            ...
            columns: ["Sociedad", "Division", "CR Tienda", "No Empleado", "Fecha Inicio", "Fecha Fin", "Monto Diario"],
            types: ["String", "String", "String", "String", "Date", "Date", "Decimal"],
            LogPage: "Excepciones de Tiendas",
            LogType: "Validacion",
            FileType: "ExcepcionesTiendas",
            Extension: ".xlsx",
            LogBody: "Inicia validacion para carga de Excepciones de Tiendas",
            Period: "",
        ...
        <div class="row">
                ...
                <div class="card bg-light card-danger">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-12">Archivo de Excepciones de Tiendas</label>
                                        <div class="col">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de Excepciones de Tiendas"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_ExcepcionTiendas.xlsx" class="btn btn-sm float-right btn-primary mr-2" data-toggle="tooltip" data-placement="top" title="Descarga de plantilla para importación de Excepciones de Tiendas"><i class="fas fa-download fa-fw"></i>Descargar Plantilla</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12" style="margin-top: -8px;">
                ...
                <div id="WarningPanel" class="RespuestaPanel card border-warning" style="display: none;">
                    <div class="card-header text-warning lead">Confirmación de carga parcial de Excepciones de Tiendas<span class="badge badge-warning float-right"><i class="fas fa-exclamation-circle fa-fw"></i>Advertencia</span></div>
                    <div class="card-body">
