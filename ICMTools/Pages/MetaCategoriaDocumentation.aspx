<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="MetaCategoriaDocumentation.aspx.vb" Inherits="ICMTools.MetaCategoriaDocumentation" %>
<%@ MasterType VirtualPath="~/Master/MasterPage.Master" %>

<%--Contenedor de botones en TopBar--%>
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/MetaCategoria.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/MetaCategoriaDocumentation.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Metas Categorías Pesos Documentación</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                    ...
                    <nav class="nav nav-pills flex-column">
                        <a class="nav-link active" href="#item-1">Módulo Meta Categoría Pesos</a>
                        <nav class="nav nav-pills flex-column">
            ...
            <div class="col-md-8">
                <h4 id="item-1">Módulo Meta Categoría Pesos</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de las metas de categorías pesos de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la importación de metas categorias desde la <a href="../Pages/MetaCategoria.aspx">página de carga</a>.</p>
                <h5 id="item-2-1">Descarga</h5>
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).                    
                    <a href="../TemplateFiles/ICMToolsPlantilla_MetasCategoriaPesos.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3" src="../images/Modulos/MetaCategoriaPesos/Ejemplo_MetaCategoriaPesos.png" />
                ...
                <p>Es importante tome en cuenta estos puntos al generar el archivo:</p>
                 <ul>
                     ...
                     <li>El nombre del archivo podrá ser modificado, para ICMTools es indistinto el nombre que usted decida utilizar siempre y cuando al final contenga un guíon bajo y una clave de CCNomina (Ejemplo: MetaCategoriaPesos_118A.xlsx).</li>
                     <li>El archivo debe ser extension .xlsx o .csv (separado por comas).</li>
                     <li>El archivo deberá contener los registros necesarios a partir de la fila 2.</li>
                 </ul>



                <h4 id="item-3">Carga</h4>
                <p>Para iniciar la carga de las Metas Categorias Pesos deberá tener listo el archivo y acceder a la <a href="../Pages/MetaCategoria.aspx">página de carga</a>.</p>                 
                <img class="mb-3 img-fluid" src="../images/Modulos/MetaCategoriaPesos/Pantalla_CargaMetaCategoriaPesos.png?v=1" />
                
                 <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo que desea utilizar:</p>

                 <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga Meta Categoría Pesos no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <p>Las primeras validaciones que ICMTools realizará, serán en el formato del archivo Excel:</p>
                <ul>
                    <li>El archivo deberá de contener solo 3 columnas.</li>                    
                    <li>No se validarán mayúsculas o minúsculas, pero los nombres de las columnas deberán ser: CR PLAZA, CR TIENDA, METAS</li>
                    ...
                    <li>El formato Fecha  debe ser DD/MM/YYYY, por ejemplo 15/09/2025.</li>
                </ul>
            </div>
        </div>
    </div>
