<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="CategoriaMontosMetas.aspx.vb" Inherits="ICMTools.CategoriaMontosMetas" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/CategoriaMontosMetas.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/CategoriaMontosMetasDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Categoría de Montos de Metas</title>
    <script type="text/javascript">
        const pageConfig = {
            maxFileSize: "<%= ConfigurationManager.AppSettings("maxFileSize")%>",
            fileUploadSelector: "#<%= AsyncFileUpload1.ClientID %>",
			FileType: "IncentivoCerveza\\CategoriaMontosMetas",
            columns: ["PlazaCR", "StoreCR", "Goal"],
            types: ["String", "String", "Decimal"],
            LogPage: "CategoriaMontosMetas",
            LogType: "Validacion",
            LogBody: "Inicia validación para carga de Categoría de Montos de Metas",
            Extension: ".xlsx"
        };
    ...
    <script src="../js/CategoriaMontosMetas.js"></script>
</asp:Content>
        ...
        <div class="row">
                ...
                <div class="card bg-light card-danger">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-12">Archivo de Categoría de montos de metas</label>
                                        <div class="col">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de Categoría de Montos de Metas"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_CategoriaMontosMetas.xlsx" class="btn btn-sm btn-primary float-right mr-2" data-toggle="tooltip" data-placement="top" title="Descarga de plantilla para importación de Categoría de Montos de Metas"><i class="fas fa-download fa-fw"></i>Descargar Plantilla</a>
                            </div>
                        </div>
                    </div>
                    <!-- card footer -->
            ...
            <div class="col-12" style="margin-top: -8px;">
                ...
                <div id="successPanel" class="card border-success" style="display: none;">
                    <div class="card-header text-success lead">Confirmación de Carga Exitosa de Categoría de Montos de Metas<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
                    <div class="card-body">
