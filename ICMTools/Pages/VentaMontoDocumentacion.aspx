<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="VentaMontoDocumentacion.aspx.vb" Inherits="ICMTools.VentaMontoDocumentacion" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/VentaMonto.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/VentaMontoDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Venta Monto Documentación</title>
</asp:Content>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
              <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                ...
                <nav class="nav nav-pills flex-column">
                  <a class="nav-link active" href="#item-1">Módulo Venta Monto</a>
                  <nav class="nav nav-pills flex-column">
            ...
            <div class="col-md-8">                
                ...
                <h4 id="item-1">Módulo Venta Monto</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de Venta Monto de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la carga de Venta Monto desde la <a href="../Pages/VentaMonto.aspx">página de carga</a>.</p>

                <h5 id="item-2-1">Descarga</h5>                
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_VentaMonto_CCNOM.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3 img-fluid" src="../images/Modulos/Categoria/Ejemplo_VentaMonto.png?v=2"/>
                ...
                <ul>
                    ...
                    <li>El nombre del archivo podrá ser modificado, para ICMTools es indistinto el nombre que usted decida utilizar siempre y cuando al final contenga un guíon bajo y una clave de CCNomina (Ejemplo: VentaMonto_118A.xlsx).</li>
                ...
                <p>Para iniciar la carga de Venta Monto deberá tener listo el archivo y acceder a la <a href="../Pages/VentaMonto.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/Categoria/Pantalla_VentaMonto.png?v=2"/>

                <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo a utilizar:</p>
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga Venta Monto no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>

                <p>Deberá seleccionar una opción en cada uno de los filtros y seleccionar el archivo a utilizar (opcional):</p>
                <ul>
                ...
                <ul>
                    ...
                    <li>No se validarán mayúsculas ni minúsculas, pero los nombres de las columnas deberán ser: Tienda, CR Tienda, Plaza., CR Plaza, CERVEZA.</li>
