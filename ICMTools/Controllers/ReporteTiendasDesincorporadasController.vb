...
Public Class ReporteTiendasDesincorporadasController
    ...
    <HttpPost>
    <Route("api/tiendasdesincorporadas/cargarinfo")>
    ...
    <HttpPost>
    <Route("api/tiendasdesincorporadas/enviarinformacion")>
    Public Async Function EnvioTiendasDesincorporadas(<FromBody> request As SendInfoRequest) As Task(Of IHttpActionResult)
        Dim logger = Log _
                .ForContext("Pantalla", request.Screen) _
                .ForContext("Usuario", mUser.Email) _
                .ForContext("Periodo", request.Period) _
