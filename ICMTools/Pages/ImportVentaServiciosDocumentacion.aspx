<%@ Page Title="Documentación: Venta Servicios" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ImportVentaServiciosDocumentacion.aspx.vb" Inherits="ICMTools.ImportVentaServiciosDocumentacion" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/ImportVentaServicios.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ImportVentaServiciosDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Venta Servicios Documentación</title>
</asp:Content>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
              <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                ...
                <nav class="nav nav-pills flex-column">
                  <a class="nav-link active" href="#item-1">Módulo Venta Servicios</a>
                  <nav class="nav nav-pills flex-column">
            ...
            <div class="col-md-8">                
                ...
                <h4 id="item-1">Módulo Venta Servicios</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de Venta Servicios de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la carga de Venta Servicios desde la <a href="../Pages/ImportVentaServicios.aspx">página de carga</a>.</p>

                <h5 id="item-2-1">Descarga</h5>                
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_VentaServicios.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3 img-fluid" src="../images/Modulos/ImportVentaServicios/Ejemplo_ImportVentaServicios.png?v=1"/>
                ...
                <p>Para iniciar la carga de Venta Servicios deberá tener listo el archivo y acceder a la <a href="../Pages/ImportVentaServicios.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/ImportVentaServicios/Pantalla_ImportVentaServicios.png?v=1"/>

                <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo que desea utilizar:</p>
                
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga Venta Servicios no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <ul>
                    ...
                    <li>No se validarán mayúsculas ni minúsculas, pero los nombres de las columnas deberán ser: StoreID, PlazaCR, Plaza, StoreCR, Store, CashierID, PayeeID, Subcategory, UnitsSold, CreationDate.</li>
