<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="TiendasDesincorporadas.aspx.vb" Inherits="ICMTools.TiendasDesincorporadas" Async="true"%>
...
const configuraciones = {
    ...
    page: "TiendasDesincorporadas",
    carga: {

        periodSelector: "#SelectPeriod",
        fileType: "TiendasDesincorporadas",
        extension: ".xlsx",
        fileClass: "ICMTools.TiendasDesincorporadasExcelDto",
        headerRow:3
    }
}
            ...
            function initializePage() {
                ...
                const app = $("#TiendasDesincorporadasApp");
    ...
    <q>ws</q>
    <script src="../js/TiendasDesincorporadas.js?v=1"></script>
</asp:Content>

<%-- Contenedor principal --%>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="TiendasDesincorporadasApp"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-12">Archivo de Tiendas Desincorporadas</label>
                                        <div class="col">
