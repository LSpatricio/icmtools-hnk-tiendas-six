<%@ Page Title="Carga: MultiTienda Fijo Entrada" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="MultiTiendaFijoEntrada.aspx.vb" Inherits="ICMTools.MultiTiendaFijoEntrada" %>
<%@ MasterType VirtualPath="~/Master/MasterPage.Master" %>

<%--Contenedor de botones en TopBar--%>
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/MultiTiendaFijoEntrada.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/MultiTiendaFijoEntradaDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>MultiTienda Fijo Entrada</title>
     ...
     <script type="text/javascript">
         ...
         const pageConfig = {
             ...
             columns: ["CASOTABULADOR", "CRPLAZA_A", "CRTIENDA_A", "CRPLAZA_B", "CRTIENDA_B", "BEGDA", "ENDDA", "LGART"],
             FileType: "Multi_Tienda_Fijo_Entrada",
             types: ["Integer", "String", "String", "String", "String", "Date", "Date", "String"],
             LogPage: "MultiTienda Fijo Entrada",
             LogType: "Validacion",
             LogBody: "Inicia validación para carga de MultiTienda Fijo Entrada",
             Extension: ".xlsx",
             apiUploadData: "/api/multitiendafijoentrada/uploaddata"
         };
    ...
    <script src="../js/MultiTiendaFijoEntrada.js"></script>
</asp:Content>
          ...
          <div class="row">
                  ...
                  <div class="card bg-light card-danger">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <label class="control-label col-sm-12">Archivo de MultiTienda Fijo Entrada</label>
                            <div  class="col">
                      ...
                      <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de MultiTienda Fijo Entrada"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_MultiTiendaFijoEntrada.xlsx" class="btn btn-sm btn-primary float-right mr-2"  data-toggle="tooltip" data-placement="top" title="Descarga de Plantilla MultiTienda Fijo Entrada para importación de MultiTienda Fijo Entrada"><i class="fas fa-download fa-fw"></i>Descargar plantilla</a>
                            </div>
                        </div>
                      </div><!-- card footer -->
                  </div>
              ...
              <div class="col-12" style="margin-top: -8px;">
                ...
                <div id="successPanel" class="RespuestaPanel card border-success" style="display:none;">
                    <div class="card-header text-success lead">Confirmación de Carga Exitosa de MultiTienda Fijo Entrada<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
                    <div class="card-body">
                ...
                <div id="WarningPanel" class="RespuestaPanel card border-warning" style="display:none;">
                    <div class="card-header text-warning lead">Confirmación de carga parcial de MultiTienda Fijo Entrada<span class="badge badge-warning float-right"><i class="fas fa-exclamation-circle fa-fw"></i>Advertencia</span></div>
                    <div class="card-body">
