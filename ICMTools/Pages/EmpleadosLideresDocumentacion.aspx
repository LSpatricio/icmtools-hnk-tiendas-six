<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="EmpleadosLideresDocumentacion.aspx.vb" Inherits="ICMTools.EmpleadosLideresDocumentacion" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/EmpleadosLideres.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/EmpleadosLideresDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Empleados Líderes Documentación</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
              <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                ...
                <nav class="nav nav-pills flex-column">
                  <a class="nav-link active" href="#item-1">Módulo de Empleados Líderes</a>
                  <nav class="nav nav-pills flex-column">
            ...
            <div class="col-md-8">                
                <h4 id="item-1">Módulo Empleados Líderes</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de Empleados Líderes de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la carga de Empleados Líderes desde la <a href="../Pages/EmpleadosLideres.aspx">página de carga</a>.</p>

                <h5 id="item-2-1">Descarga</h5>                
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_EmpleadosLideres.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3 img-fluid" src="../images/Modulos/EmpleadosLideres/Ejemplo_EmpleadosLideres.png?v=1"/>
                ...
                <p>Para iniciar la carga de Empleados Líderes deberá tener listo el archivo y acceder a la <a href="../Pages/EmpleadosLideres.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/EmpleadosLideres/Pantalla_EmpleadosLideres.png?v=1"/>

                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga Empleados Líderes no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <ul>
                    <li>El archivo deberá contener solo 13 columnas.</li>                    
                    <li>No se validarán mayúsculas ni minúsculas, pero los nombres de las columnas deberán ser: LLAVE , ZONA , PLAZA, CR PLAZA, CR TIENDA, DIMENSION, TIENDA, DISTRITO, ASESOR, MESOPS, LIDER, RFC / NO. EMP,CLAS FINAL.</li>
