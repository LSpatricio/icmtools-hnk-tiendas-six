...
Public Class PagosManualesCarga
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.Master.PageName = "Pagos Manuales"

            If Not Session.Item("User") Is Nothing Then
                mUser = CType(Session.Item("User"), User)
                mLog = New Log
                mLog.insertLog("PagosManuales", "ACCESO", "Acceso a Pagos Manuales")
            Else
    ...
    Sub AsyncFileUpload1_UploadedComplete(ByVal sender As Object, ByVal e As AsyncFileUploadEventArgs) Handles AsyncFileUpload1.UploadedComplete
        ...
        If Not Session.Item("User") Is Nothing Then
            ...
            Dim folder As String = "~\UploadedFiles\PagosManuales\"
            ...
            mLog = New Log
            mLog.insertLog("PagosManuales", "ARCHIVO IMPORTADO", $"Archivo de Pagos Manuales importado: {safeFileName}")
        Else
            Response.Redirect(ConfigurationManager.AppSettings("LoginPage"), False)
        End If
    End Sub
