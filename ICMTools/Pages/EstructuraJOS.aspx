<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="EstructuraJOS.aspx.vb" Inherits="ICMTools.EstructuraJOS" Async="true"%>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/EstructuraJOS.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/EstructuraJOSDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>SA027 - Estructura JOS</title>
...
//        selector: "",
//        fileType: "EstructuraJOS",
//        extension: ".xlsx",
//        fileClass: "ICMTools.EstructuraJOSExcelDto",
//        headerRow:4
//    },
//    logging: {
//        page: "EstructuraJOS",
//        type: "Validacion",
//        body: "Inicia validación para carga de Estructura JOS"
//    },

//    api: {
//        uploadData: "/api/EstructuraJOS/uploaddata"
//    }
        //}
    ...
    <q>ws</q>
    <script src="../js/EstructuraJOS.js"></script>
</asp:Content>
        ...
        <div class="row">
                ...
                <div class="card bg-light card-danger">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <%--<select id="SelectPeriod" class="form-control form-control-sm" clientidmode="Static">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-12">Archivo de SA027 - Estructura JOS</label>
                                        <div class="col">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo SA027 - Estructura JOS"><i class="fas fa-upload fa-fw"></i>Iniciar Importacion</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_SA027EstructuraJOS_CCNOM.xlsx" class="btn btn-sm btn-primary float-right mr-2" data-toggle="tooltip" data-placement="top" title="Descarga de Plantilla SA027 - Estructura JOS para la importación"><i class="fas fa-download fa-fw"></i>Descargar Plantilla</a>
                            </div>
                        </div>
                    </div>
                    <!-- card footer -->
            ...
            <div class="col-12" style="margin-top: -8px;">
                ...
                <div id="successPanel" class="RespuestaPanel card border-success" style="display: none;">
                    <div class="card-header text-success lead">Confirmación de Carga Exitosa de Estructura JOS<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
                    <div class="card-body">
                ...
                <div id="WarningPanel" class="RespuestaPanel card border-warning" style="display: none;">
                    <div class="card-header text-warning lead">Confirmación de carga parcial de Estructura JOS<span class="badge badge-warning float-right"><i class="fas fa-exclamation-circle fa-fw"></i>Advertencia</span></div>
                    <div class="card-body">
