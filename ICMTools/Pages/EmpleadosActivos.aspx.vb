...
Public Class IncentivoCategorias
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.Master.PageName = "Empleados Activos"
    ...
    Sub AsyncFileUpload_UploadedComplete(ByVal sender As Object, ByVal e As AsyncFileUploadEventArgs) Handles AsyncFileUpload1.UploadedComplete, AsyncFileUpload2.UploadedComplete
        If Not Session.Item("User") Is Nothing Then
            ...
            Dim folder As String = "~\UploadedFiles\Categoria\EmpleadosActivos\" & If(sender.ClientID = "ContentPlaceHolder1_AsyncFileUpload1", "Inicial", "Final")
            ...
            mLog = New Log
            mLog.insertLog("Empleados Activos", "ARCHIVO IMPORTADO", $"Archivo de Empleados Activos importado: {safeFileName}")
        Else
            Response.Redirect(ConfigurationManager.AppSettings("LoginPage"), False)
        End If
    End Sub
