...
Public Class VentaUnidadesCategoria
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.Master.PageName = "Venta Unidades"

            If Not Session.Item("User") Is Nothing Then
                mUser = CType(Session.Item("User"), User)
                mLog = New Log
                mLog.insertLog("Venta Unidades Categoria", "ACCESO", "Acceso a Venta Unidades Categoria")
            Else
    ...
    Sub AsyncFileUpload1_UploadedComplete(ByVal sender As Object, ByVal e As AsyncFileUploadEventArgs) Handles AsyncFileUpload1.UploadedComplete
        If Not Session.Item("User") Is Nothing Then
            ...
            Dim folder As String = "~\UploadedFiles\Categoria\VentaUnidades\"
            ...
            mLog = New Log
            mLog.insertLog("Venta Unidades", "ARCHIVO IMPORTADO", $"Archivo de Venta Unidades importado: {safeFileName}")
        Else
            Response.Redirect(ConfigurationManager.AppSettings("LoginPage"), False)
        End If
    End Sub
