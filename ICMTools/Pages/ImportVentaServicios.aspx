<%@ Page Title="Carga: Venta Servicios" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ImportVentaServicios.aspx.vb" Inherits="ICMTools.ImportVentaServicios" %>
<%@ MasterType VirtualPath="~/Master/MasterPage.Master" %>

<%--Contenedor de botones en TopBar--%>
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/ImportVentaServicios.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ImportVentaServiciosDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>ImportVentaServicios</title>

     <script type="text/javascript">
         const pageConfig = {
             maxFileSize: "<%= ConfigurationManager.AppSettings("maxFileSize")%>",
             fileUploadSelector: "#<%= AsyncFileUpload1.ClientID %>",
             columns: ["StoreID", "PlazaCR", "Plaza", "StoreCR", "Store", "CashierID", "PayeeID", "Subcategory", "UnitsSold", "CreationDate"],
             FileType: "Servicios\\VentaServicios",
             types: ["String", "String", "String", "String", "String", "String", "String", "String", "Decimal", "String"],
             LogPage: "Venta Servicios",
             LogType: "Validacion",
             LogBody: "Inicia validación para carga de Venta Servicios",
             Extension: ".xlsx"
         };
    ...
    <script src="../js/VentaServicios.js"></script>
</asp:Content>
          ...
          <div class="row">
                  ...
                  <div class="card bg-light card-danger">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <label class="control-label col-sm-12">Archivo de Venta Servicios</label>
                            <div  class="col">
                      ...
                      <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de Venta Servicios"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_VentaServicios.xlsx" class="btn btn-sm btn-primary float-right mr-2"  data-toggle="tooltip" data-placement="top" title="Descarga de Plantilla Venta Servicios para importación de Venta Servicios"><i class="fas fa-download fa-fw"></i>Descargar plantilla</a>
                            </div>
                        </div>
                      </div><!-- card footer -->
                  </div>
              ...
              <div class="col-12" style="margin-top: -8px;">
                ...
                <div id="successPanel" class="card border-success" style="display:none;">
                    <div class="card-header text-success lead">Confirmación de Carga Exitosa de Venta Servicios<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div> </div>
                </div>
          </div>
      </div>
