<%@ Page Title="SA132" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="SA132.aspx.vb" Inherits="ICMTools.SA132" Async="true" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Carga de SA132" />
    <title>SA132</title>
    ...
    <script type="text/javascript">
        const configuraciones = {
            ...
            carga: {
                ...
                fileType: "SA132",
                extension: ".xlsx",
                fileClass: "ICMTools.SA132ExcelDto",
                headerRow: 4
            }
        };
    ...
    <script src="../js/SA132.js?v=1"></script>
</asp:Content>
            ...
            <div class="row">
                    ...
                    <div class="card bg-light card-danger">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="control-label col-sm-12">Archivo de SA132</label>
                                            <div class="col">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <button id="btnStartImport" class="btn btn-sm btn-primary float-right" title="Iniciar importacion de SA132">
                ...
                <div class="col-12" style="margin-top: -8px;">
                    ...
                    <div id="successPanel" class="RespuestaPanel card border-success" style="display: none;">
                        <div class="card-header text-success lead">Carga exitosa de SA132<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
                        <div class="card-body">
