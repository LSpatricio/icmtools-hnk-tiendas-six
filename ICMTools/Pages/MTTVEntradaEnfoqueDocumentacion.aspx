<%@ Page Title="Documentación: Entrada Enfoque" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="MTTVEntradaEnfoqueDocumentacion.aspx.vb" Inherits="ICMTools.MTTVEntradaEnfoqueDocumentacion" %>
<%@ MasterType VirtualPath="~/Master/MasterPage.Master"%>

<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/MTTVEntradaEnfoque.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/MTTVEntradaEnfoqueDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Documentación de Entrada Enfoque</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
              <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                ...
                <nav class="nav nav-pills flex-column">
                  <a class="nav-link active" href="#item-1">Módulo Entrada Enfoque</a>
                  <nav class="nav nav-pills flex-column">
            ...
            <div class="col-md-8">
                <h4 id="item-1">Módulo Entrada Enfoque</h4>
                ...
                <p>Apoyar al usuario en la tarea de importar el archivo de Entrada Enfoque de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la importación de Entrada Enfoque desde la <a href="../Pages/MTTVEntradaEnfoque.aspx">página de carga</a>.</p>
                <h5 id="item-2-1">Descarga</h5>
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_MTTVEntradaEnfoque.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>Importante!</strong> La plantilla contiene los nombres de las columnas en la fila 1 y una fila con valores de Entrada Enfoque, si utiliza este archivo es importante modifique la fila 2, ya que este es solo un ejemplo de como deben ser ingresadas las Entradas.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>

                <img class="mb-3" src="../images/Modulos/MultiTiendaVariable/EntradaEnfoque/Ejemplo_EntradaEnfoque.png"/>
                ...
                <ul>
                    ...
                    <li>El archivo deberá contener los registros de Entrada Enfoque necesarios a partir de la fila 2.</li>
                </ul>

                <h4 id="item-3">Carga</h4>
                <p>Para iniciar la carga de Entrada Enfoque deberá tener listo el archivo y acceder a la <a href="../Pages/MTTVEntradaEnfoque.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/MultiTiendaVariable/EntradaEnfoque/Pantalla_CargaEntradaEnfoque.png?v=2"/>
                <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo que desea utilizar</p>
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                    <strong>¡Importante!</strong> En el caso de la pantalla de carga de Entrada Enfoque no es necesario llenar las cajas de selección Sociedad y División de Personal.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <ul>
                    <li>El archivo deberá de contener solo 4 columnas.</li>
                    <li>Sin tomar en cuenta la fila de los nombres de las columnas.</li>
                    <li>No se validarán mayúsculas o minúsculas, pero los nombres de las columnas deberán ser: TDA, ENFOQ, BEGDA, ENDDA.</li>
