...
Public Class EmpleadosLideres
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.Master.PageName = "Empleados Lideres"

            If Not Session.Item("User") Is Nothing Then
                mUser = CType(Session.Item("User"), User)
                mLog = New Log
                mLog.insertLog("Empleados Líderes", "ACCESO", "Acceso a Tiendas Ganadoras")
            Else
    ...
    Sub AsyncFileUpload1_UploadedComplete(ByVal sender As Object, ByVal e As AsyncFileUploadEventArgs) Handles AsyncFileUpload1.UploadedComplete
        If Not Session.Item("User") Is Nothing Then
            ...
            Dim folder As String = "~\UploadedFiles\EmpleadosLideres\"
            ...
            mLog = New Log
            mLog.insertLog("Empleados Lideres", "ARCHIVO IMPORTADO", $"Archivo de Empleados Lideres importado: {safeFileName}")
        Else
            Response.Redirect(ConfigurationManager.AppSettings("LoginPage"), False)
        End If
    End Sub
