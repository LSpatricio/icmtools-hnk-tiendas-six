<%@ Page Title="Documentación: Ventas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ImportVentasDocumentacion.aspx.vb" Inherits="ICMTools.ImportVentasDocumentacion" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/ImportVentas.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ImportVentasDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Ventas Documentación</title>
</asp:Content>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
              <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                ...
                <nav class="nav nav-pills flex-column">
                  <a class="nav-link active" href="#item-1">Módulo de Ventas</a>
                  <nav class="nav nav-pills flex-column">
            ...
            <div class="col-md-8">                
                ...
                <h4 id="item-1">Módulo de Ventas</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de Ventas de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo csv con la estructura necesaria para poder realizar la carga de Ventas desde la <a href="../Pages/ImportVentas.aspx">página de carga</a>.</p>

                <h5 id="item-2-1">Descarga</h5>                
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_Ventas.csv" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                    <strong>¡Importante!</strong> El archivo a cargar debe ser exclusivamente en formato csv delimitado por comas.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <img class="mb-3 img-fluid" src="../images/Modulos/VentaSugerida/Ejemplo_Ventas.png?v=1"/>
                
                <h5 id="item-2-2">Archivo</h5>
                <p>Es importante tomar en cuenta estos puntos al generar el archivo:</p>
                <ul>
                    <li>El archivo no deberá exceder el peso de 300 MB.</li>
                    <li>El nombre del archivo podrá ser modificado; para ICMTools es indistinto el nombre que usted decida utilizar.</li>
                    <li>El archivo debe ser de extensión .csv (separado por comas)<strong> exclusivamente</strong>.</li>
                ...
                <p>Para iniciar la carga de Ventas deberá tener listo el archivo y acceder a la <a href="../Pages/ImportVentas.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/VentaSugerida/Pantalla_Ventas.png?v=1"/>

                <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo que desea utilizar:</p>
                
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga de Ventas no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <ul>
                    ...
                    <li><strong>Archivo: </strong>Deberá hacer clic en el botón 'Elegir archivo' o arrastrar hasta la sección señalada el archivo de extensión .csv (separado por comas) a utilizar para la carga.</li>
                </ul>
                ...
                <ul>
                    <li>El archivo deberá contener solo 12 columnas.</li>                    
                    <li>No se validarán mayúsculas ni minúsculas, pero los nombres de las columnas deberán ser: IDSTORE, PLAZA_CVE, PLAZA_DES, TIENDA_CVE, TIENDA_DES, ID_USUARIO, ID_EMPLEADO, VT_FOL_PRO, PROMOCION_DESC, TIPO_PROMOCION, UDSNETAS_REALES, CREATIONDATE.</li>
