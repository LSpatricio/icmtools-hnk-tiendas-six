<%@ Page Title="Documentación: Monto Distribuible" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="MontoDistribuibleCategoriaDocumentacion.aspx.vb" Inherits="ICMTools.MontoDistribuibleCategoriaDocumentacion" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/MontoDistribuibleCategoria.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/MontoDistribuibleCategoriaDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Monto Distribuible Documentación</title>
</asp:Content>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">                
                ...
                <h4 id="item-1">Módulo Monto Distribuible</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de Monto Distribuible de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la carga de Monto Distribuible desde la <a href="../Pages/MontoDistribuibleCategoria.aspx">página de carga</a>.</p>

                <h5 id="item-2-1">Descarga</h5>                
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_MontoDistribuible_CCNOM.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3 img-fluid" src="../images/Modulos/Categoria/Ejemplo_MontoDistribuible.png?v=2"/>
                ...
                <ul>
                    ...
                    <li>El nombre del archivo podrá ser modificado, para ICMTools es indistinto el nombre que usted decida utilizar siempre y cuando al final contenga un guíon bajo y una clave de CCNomina (Ejemplo: MontoDistribuible_118A.xlsx).</li>
                ...
                <p>Para iniciar la carga de Monto Distribuible deberá tener listo el archivo y acceder a la <a href="../Pages/MontoDistribuibleCategoria.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/Categoria/Pantalla_MontoDistribuible.png?v=2"/>

                <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo que desea utilizar:</p>
                
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga Monto Distribuible no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <ul>
                    <li>El archivo deberá contener solo 5 columnas.</li>                    
                    <li>No se validarán mayúsculas ni minúsculas, pero los nombres de las columnas deberán ser: PLAZA, CR TIENDA, DESC_TIENDA, MONTO SIN IMPUESTOS, MONTO CON IMPUESTOS.</li>
