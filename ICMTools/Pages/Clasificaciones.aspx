<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Clasificaciones.aspx.vb" MasterPageFile="~/Master/MasterPage.Master" Inherits="ICMTools.Clasificaciones" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/Clasificaciones.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ClasificacionesDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Form para Importación de clasificaciones con procesos de validación"/>
    ...
    <title>Clasificaciones</title>
     ...
     <script type="text/javascript">
         ...
         var apiUrl = '<%= ResolveUrl("~/api/clasificaciones/InsertInfoBD") %>';

         const pageConfig = {
             FileType: "Clasificaciones",
             maxFileSize: "<%= ConfigurationManager.AppSettings("maxFileSize")%>",
             fileUploadSelector: "#<%= AsyncFileUpload1.ClientID %>",
             columns: ["IDStore", "Date", "Value"],
             types: ["String", "Date", "Alphabetic"],
             LogPage: "Clasificaciones",
             LogType: "Validacion",
             LogBody: "Inicia validación para Clasificaciones",
             LoadingValue: 20,
    ...
    <script src="../js/Clasificaciones.js?v=3"></script>
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-7">
                                <select id="SelectSociety" onchange="loadPersonnelDivisionsBySociety();" class="form-control form-control-sm" runat="server" clientidmode="Static" autopostback="True"></select>
                            </div>
                        </div>
                        <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <label class="control-label col-sm-12">Archivo de Clasificaciones</label>
                            <div  class="col">
              ...
              <div class="card-footer">
                  <div class="row">
                      ...
                      <div class="col-5">
                          ...
                          <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de Clasificaciones"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                        <a href="../TemplateFiles/ICMToolsPlantilla_Clasificaciones.xlsx" class="btn btn-sm btn-primary float-right mr-2"  data-toggle="tooltip" data-placement="top" title="Descarga de plantilla para importación de Clasificaciones"><i class="fas fa-download fa-fw"></i>Descargar Plantilla</a>
                      </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-12 mt-2">
         ...
         <div class="col-12" style="margin-top: -8px;">
           ...
           <div id="successPanel" class="RespuestaPanel card border-success" style="display:none;">
               <div class="card-header text-success lead">Confirmación de Carga Exitosa de Clasificaciones<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
               <div class="card-body">
           ...
           <div id="WarningPanel" class="RespuestaPanel card border-warning" style="display:none;">
               <div class="card-header text-warning lead">Confirmación de carga parcial de Clasificaciones<span class="badge badge-warning float-right"><i class="fas fa-exclamation-circle fa-fw"></i>Advertencia</span></div>
               <div class="card-body">
