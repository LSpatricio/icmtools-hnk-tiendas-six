<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ConfigSalesPercentageDocumentacion.aspx.vb" Inherits="ICMTools.ConfigSalesPercentageDocumentacion" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/ConfigSalesPercentageCarga.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ConfigSalesPercentageDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Configuración Porcentaje de Ventas Documentación</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <nav id="MyScrollNav" class="navbar navbar-expand-md navbar-light fixed bg-light flex-column sticky-top">
                    ...
                    <nav class="nav nav-pills flex-column">
                        ...
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ml-3 my-1" href="#item-3-1">Validaciones de archivos</a>
            ...
            <div class="col-md-8">
                <h4 id="item-1">Módulo Configuración Porcentaje de Ventas </h4>
                ...
                <p>Apoyar al usuario en la tarea de importar las Configuración Porcentaje de Ventas de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la importación de porcentajes de ventas desde la <a href="../Pages/ConfigSalesPercentageCarga.aspx">página de carga</a>.</p>
                <h5 id="item-2-1">Descarga</h5>
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).                    
                    <a href="../TemplateFiles/ICMToolsPlantilla_ConfiguracionPorcentajeVentas.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3" src="../images/Modulos/ConfiguracionPorcentajeVentas/Ejemplo_ConfiguracionPorcentajeVentas.png" />
                ...
                <p>Para iniciar la carga de las Configuración Porcentaje de Ventas deberá tener listo el archivo y acceder a la <a href="../Pages/ConfigSalesPercentageCarga.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/ConfiguracionPorcentajeVentas/Pantalla_CargaConfiguracionPorcentajeVentas.png?v=1" />
               <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo que desea utilizar:</p>
               
                 <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga las Configuración Porcentaje de Ventas no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <ul>
                    ...
                    <li>No se validarán mayúsculas o minúsculas, pero los nombres de las columnas deberán ser: SociedadID, PlazaID, PorcentajeSociedad</li>
