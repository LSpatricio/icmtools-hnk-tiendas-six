...
Public Class ExceptionsTiendasUpload
    Inherits Page
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.Master.PageName = "Excepciones de Tiendas"

            If Session.Item("User") IsNot Nothing Then
                mUser = CType(Session.Item("User"), User)
                LoadControls()
                mLog = New Log
                mLog.insertLog("EXCEPCIONES DE TIENDAS", "ACCESO", "Acceso a carga de Excepciones de Tiendas")
            Else
    ...
    Sub AsyncFileUpload1_UploadedComplete(ByVal sender As Object, ByVal e As AsyncFileUploadEventArgs) Handles AsyncFileUpload1.UploadedComplete
        If Session.Item("User") IsNot Nothing Then
            ...
            Dim folder As String = "~\UploadedFiles\ExcepcionesTiendas\"
            ...
            mLog = New Log
            mLog.insertLog("EXCEPCIONES DE TIENDAS", "ARCHIVO IMPORTADO", $"Archivo de Excepciones de Tiendas importado: {safeFileName}")
        Else
            Response.Redirect(ConfigurationManager.AppSettings("LoginPage"), False)
        End If
    End Sub
