<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="VentaUnidadesCategoria.aspx.vb" Inherits="ICMTools.VentaUnidadesCategoria" %>
...
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/VentaUnidadesCategoria.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/VentaUnidadesCategoriaDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        const pageConfig = {
            ...
            columns: ["IDStore", "CATEGORIA_DES", "CR_PLAZ", "PLAZA", "CR_TIENDA", "TIENDA", "ID_USUARIO", "ID_EMPLEADO", "udsnetas", "creationDate"],
            types: ["String", "String", "String", "String", "String", "String", "String", "String", "String", "String"],
            LogPage: "Venta Unidades",
            LogType: "Validacion",
            LogBody: "Inicia validación para carga de Venta Unidades",
            FileType: 'Categoria\\VentaUnidades',
            Extension: ".xlsx",
            apiUploadData: "/api/ventaunidadescategorias/uploaddata",
    ...
    <script src="../js/VentaUnidadesCategoria.js?v=3"></script>
</asp:Content>
        ...
        <div class="row">
                ...
                <div class="card bg-light card-danger">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-12">Archivo de Venta Unidades</label>
                                        <div class="col">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de Venta Unidades"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_VentaUnidades_118A.xlsx" class="btn btn-sm btn-primary float-right mr-2" data-toggle="tooltip" data-placement="top" title="Descarga de plantilla para importación de Venta Unidades"><i class="fas fa-download fa-fw"></i>Descargar Plantilla</a>
                            </div>
                        </div>
                    </div>
                    <!-- card footer -->
            ...
            <div class="col-12" style="margin-top: -8px;">
                ...
                <div id="successPanel" class="RespuestaPanel card border-success" style="display: none;">
                    <div class="card-header text-success lead">Confirmación de Carga Exitosa de Venta Unidades<span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
                    <div class="card-body">
                ...
                <div id="WarningPanel" class="RespuestaPanel card border-warning" style="display: none;">
                    <div class="card-header text-warning lead">Confirmación de carga parcial de Venta Unidades<span class="badge badge-warning float-right"><i class="fas fa-exclamation-circle fa-fw"></i>Advertencia</span></div>
                    <div class="card-body">
