<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ConfiguracionDistribucionesDocumentacion.aspx.vb" Inherits="ICMTools.ConfiguracionDistribucionesDocumentacion" %>
<%@ MasterType VirtualPath="~/Master/MasterPage.Master" %>

<%--Contenedor de botones en TopBar--%>
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/ConfiguracionDistribuciones.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ConfiguracionDistribucionesDocumentacion.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Configuración de Distribuciones Documentación</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <h4 id="item-1">Módulo Configuración de Distribuciones</h4>
                ...
                <p>Apoyar al usuario en la tarea de carga de Configuración de Distribuciones de manera sencilla y rápida.</p>
                ...
                <p>La plantilla es un archivo de Excel con la estructura necesaria para poder realizar la carga de Configuración de Distribuciones desde la <a href="../Pages/ConfiguracionDistribuciones.aspx">página de carga</a>.</p>
                <h5 id="item-2-1">Descarga</h5>
                <p>
                    Plantilla de referencia para iniciar el llenado (recomendable).
                    <a href="../TemplateFiles/ICMToolsPlantilla_ConfiguracionDistribuciones.xlsx" class="btn btn-outline-info btn-sm"><i class="fas fa-download fa-fw"></i>Descargar archivo</a>
                </p>
                ...
                <img class="mb-3 img-fluid" src="../images/Modulos/IncentivoCerveza/Ejemplo_ConfiguracionDistribuciones.png?v=1"/>                
                ...
                <p>Para iniciar la carga de Configuración de Distribuciones deberá tener listo el archivo y acceder a la <a href="../Pages/ConfiguracionDistribuciones.aspx">página de carga</a>.</p>
                <img class="mb-3 img-fluid" src="../images/Modulos/IncentivoCerveza/Pantalla_ConfiguracionDistribuciones.png"/>
                <p>Deberá seleccionar una opción en cada uno de los filtros y elegir el archivo a utilizar:</p>
                <div class="alert alert-warning alert-dismissible fade show text-justify" role="alert">
                  <strong>¡Importante!</strong> En el caso de la pantalla de carga Configuración de Distribuciones no es necesario llenar las cajas de selección Sociedad y División de Personal.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <ul>
                    ...
                    <li>No se validarán mayúsculas o minúsculas, pero los nombres de las columnas deberán ser: Sociedad, Puesto, Porcentaje.</li>
