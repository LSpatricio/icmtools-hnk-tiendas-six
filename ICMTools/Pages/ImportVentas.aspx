<%@ Page Title="Carga: Ventas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MasterPage.Master" CodeBehind="ImportVentas.aspx.vb" Inherits="ICMTools.ImportVentas" %>
<%@ MasterType VirtualPath="~/Master/MasterPage.Master" %>

<%--Contenedor de botones en TopBar--%>
<asp:Content ID="TopbarContent" ContentPlaceHolderID="TopbarContent" runat="server">
    <div class="d-flex gap-1">
        <a href="../Pages/ImportVentas.aspx" class="btn active btn-sm btn-bar d-flex flex-column align-items-center text-dark">
            <i class="fas fa-upload fa-2x"></i>
            <small>Carga</small>
        </a>
        <a href="../Pages/ImportVentasDocumentacion.aspx" class="btn btn-sm btn-bar d-flex flex-column align-items-center text-dark">
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Ventas</title>
     ...
     <script type="text/javascript">
         ...
         const pageConfig = {
             maxFileSize: "<%= ConfigurationManager.AppSettings("MassiveMaxFileSize")%>",
             fileUploadSelector: "#<%= AsyncFileUpload1.ClientID %>",
             columns: ["IDSTORE", "PLAZA_CVE", "PLAZA_DES", "TIENDA_CVE", "TIENDA_DES", "ID_USUARIO", "ID_EMPLEADO", "VT_FOL_PRO", "PROMOCION_DESC", "TIPO_PROMOCION", "UDSNETAS_REALES", "CREATIONDATE"],
             FileType: "VentaSugerida\\ImportVentas",
             types: ["String", "String", "String", "String", "String", "String", "String", "String", "String", "String", "String", "String"],
             LogPage: "Importación de Ventas",
             LogType: "Validacion",
             LogBody: "Inicia validación para carga de Importación de Ventas",
             Extension: ".xlsx",
         };
         $(document).ready(function () {             
             ...
             $('.ResponseCSV').on('click', function (e) {
                 e.preventDefault();
                 DownloadResponse();
             })
         });
    ...
    <script src="../js/ImportVentas.js?v=2"></script>
</asp:Content>
                  ...
                  <div class="card bg-light card-danger">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <label class="control-label col-sm-12">Archivo de Ventas</label>
                            <div  class="col">
                                <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                    <!-- Drop Zone -->
                                    <div class="upload-drop-zone" id="drop-zone">
                                        <ajaxToolkit:AsyncFileUpload ID="AsyncFileUpload1" runat="server"  ThrobberID="myThrobber" OnClientUploadComplete="uploadComplete" OnClientUploadError="uploadError" OnClientUploadStarted="beforeUploadStartsIV" Width="100%" ErrorBackColor="#FFCCFF" CompleteBackColor="#CCFFCC" ForeColor="Black" />
                                    </div>
                      ...
                      <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <button id="btnStartImport" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" data-placement="top" title="Click aquí despues de elegir archivo de Ventas"><i class="fas fa-upload fa-fw"></i>Iniciar Importación</button>
                                <a href="../TemplateFiles/ICMToolsPlantilla_Ventas.csv" class="btn btn-sm btn-primary float-right mr-2"  data-toggle="tooltip" data-placement="top" title="Descarga de Plantilla de Ventas"><i class="fas fa-download fa-fw"></i>Descargar plantilla</a>
                            </div>
                        </div>
                      </div><!-- card footer -->
                  </div>
              ...
              <div class="col-12" style="margin-top: -8px;">
                <div id="errorPanel" class="RespuestaPanel card border-danger" style="display: none;">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-primary float-right ResponseCSV" data-toggle="tooltip" data-placement="left" title="Click aquí para descargar el csv con los resultados de la carga" style="margin: 1em 1em 0 0;"><i class="fas fa-file fa-fw"></i>Descargar Resultados</button>
               ...
               <div id="successPanel" class="RespuestaPanel card border-success" style="display: none;">
                    <div class="card-header text-success lead">Confirmación de Carga Exitosa de Importación de Ventas <span class="badge badge-success float-right"><i class="fas fa-check-circle fa-fw"></i>Listo</span></div>
                    <div class="card-body">
                ...
                <div id="WarningPanel" class="RespuestaPanel card border-warning" style="display:none;">
                    <div class="card-header text-warning lead">Confirmación de carga parcial de Importación de Ventas <span class="badge badge-warning float-right"><i class="fas fa-exclamation-circle fa-fw"></i>Advertencia</span></div>
                    <div class="card-body">
